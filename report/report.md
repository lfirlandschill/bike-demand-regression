...
The goal was to predict hourly bike rental demand.

The dataset contained information about:
- Weather conditions
- Time-related variables such as hour, weekday, and month

The project treated each observation independently (no time-series modeling was used)
...
- The other time-related variables (month, day) were also one-hot encoded, since they cost few extra features to do so
...
- Increasing tree depth substantially improved performance initially before overfitting occured.
